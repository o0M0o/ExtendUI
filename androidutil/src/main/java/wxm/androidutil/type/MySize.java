...
public final class MySize {
     ...
     */
    public static MySize parseSize(String string)
        ...
        try {
            return new MySize(Integer.parseInt(string.substring(0, sep_ix)),
